...
(define-constant SX u32768)
(define-constant SY u2147450879)
...
(define-constant SEL_A u1569360727)
(define-constant SEL_B u1569360727)
(define-constant SEL_C u2147450879)
;; pair-vanishing line through P0,P1 (the boundary DENOMINATOR: vanishes on seed rows 0,1)
(define-constant B01_A u1569360727)
(define-constant B01_B u578122920)
(define-constant B01_C u2147450879)
...
(define-read-only (felt-to-point (t { c0: uint, c1: uint, c2: uint, c3: uint }))
  (let ((one (contract-call? .qm31 qm31-from-m31 u1))
        (tsq (contract-call? .qm31 qm31-mul t t)))
    (let ((dinv (contract-call? .qm31 qm31-inv (contract-call? .qm31 qm31-add one tsq))))
      { x: (contract-call? .qm31 qm31-mul (contract-call? .qm31 qm31-sub one tsq) dinv),
        y: (contract-call? .qm31 qm31-mul (contract-call? .qm31 qm31-add t t) dinv) })))
...
(define-read-only (point-add-base
    ...
    (bx uint) (by uint))
  { x: (contract-call? .qm31 qm31-sub
         (contract-call? .qm31 qm31-mul-m31 zx bx)
         (contract-call? .qm31 qm31-mul-m31 zy by)),
    y: (contract-call? .qm31 qm31-add
         (contract-call? .qm31 qm31-mul-m31 zx by)
         (contract-call? .qm31 qm31-mul-m31 zy bx)) })
...
(define-read-only (qpi (v { c0: uint, c1: uint, c2: uint, c3: uint }))
  (let ((vv (contract-call? .qm31 qm31-mul v v)))
    (contract-call? .qm31 qm31-sub
      (contract-call? .qm31 qm31-add vv vv)
      (contract-call? .qm31 qm31-from-m31 u1))))
...
(define-read-only (line-sel
  ...
  (contract-call? .qm31 qm31-add
    (contract-call? .qm31 qm31-add
      (contract-call? .qm31 qm31-mul-m31 zx SEL_A)
      (contract-call? .qm31 qm31-mul-m31 zy SEL_B))
    (contract-call? .qm31 qm31-from-m31 SEL_C)))
(define-read-only (line-b01
    (zx { c0: uint, c1: uint, c2: uint, c3: uint })
    (zy { c0: uint, c1: uint, c2: uint, c3: uint }))
  (contract-call? .qm31 qm31-add
    (contract-call? .qm31 qm31-add
      (contract-call? .qm31 qm31-mul-m31 zx B01_A)
      (contract-call? .qm31 qm31-mul-m31 zy B01_B))
    (contract-call? .qm31 qm31-from-m31 B01_C)))
...
(define-read-only (cair-quotients
  ...
  { q-trans: (contract-call? .qm31 qm31-mul
               (contract-call? .qm31 qm31-mul (eval-transition t-z t-gz t-g2z) (line-sel zx zy))
               (contract-call? .qm31 qm31-inv (coset-vanish zx))),
    q-b: (contract-call? .qm31 qm31-mul
           (contract-call? .qm31 qm31-sub t-z (contract-call? .qm31 qm31-from-m31 u1))
           (contract-call? .qm31 qm31-inv (line-b01 zx zy))) })
...
(define-read-only (cair-compose
  ...
  (let ((q (cair-quotients t-z t-gz t-g2z zx zy)))
    (contract-call? .qm31 qm31-add (get q-trans q)
      (contract-call? .qm31 qm31-mul alpha (get q-b q)))))
...
(define-read-only (recomb
  ...
  (contract-call? .qm31 qm31-add
    (contract-call? .qm31 qm31-add c0-z (contract-call? .qm31 qm31-mul Q_I c1-z))
    (contract-call? .qm31 qm31-add
      (contract-call? .qm31 qm31-mul Q_U c2-z)
      (contract-call? .qm31 qm31-mul Q_IU c3-z))))
