;; contracts/full/fri.clar: GENERATED FILE. DO NOT EDIT.
;; Emitted from contracts/fri.clar by the M2 span templates at
...
(define-read-only (pi-x (x uint))
  (contract-call? .field-full m31-sub
    (contract-call? .field-full m31-mul u2 (contract-call? .field-full m31-mul x x))
    u1))
...
(define-read-only (fri-fold-step
  ...
  (unwrap-panic (if (is-eq x u0)
    none
    (some
      (let ((f0 (contract-call? .qm31-full qm31-add a b))
            (f1 (contract-call? .qm31-full qm31-mul-m31
                  (contract-call? .qm31-full qm31-sub a b)
                  (contract-call? .field-full m31-inv x))))
        (contract-call? .qm31-full qm31-add f0 (contract-call? .qm31-full qm31-mul beta f1)))))))
...
(define-read-only (fri-fold-check
  ...
  (contract-call? .qm31-full qm31-eq (fri-fold-step a b x beta) claimed))
...
(define-read-only (fri-final-ok
  ...
  (contract-call? .qm31-full qm31-eq (fri-fold-down v0 layers) final))
...
(define-read-only (fri-fold-step-hint
    ...
    (beta { c0: uint, c1: uint, c2: uint, c3: uint }))
  (begin
    (unwrap-panic (if (is-eq (contract-call? .field-full m31-mul x hint) u1) (some true) none))
    (let ((f0 (contract-call? .qm31-full qm31-add a b))
          (f1 (contract-call? .qm31-full qm31-mul-m31 (contract-call? .qm31-full qm31-sub a b) hint)))
      (contract-call? .qm31-full qm31-add f0 (contract-call? .qm31-full qm31-mul beta f1)))))
